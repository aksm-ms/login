...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield executeAzCliCommand("--version --only-show-errors", true, options);
            ...
            if (allowNoSubscriptionsLogin) {
                ...
                yield executeAzCliCommand(`login --service-principal -u "${servicePrincipalId}" -p "${servicePrincipalKey}" --tenant "${tenantId}" --only-show-errors`, true, options2);
                ...
                yield executeAzCliCommand(`account set --subscription "${subscriptionId}"--only-show-errors`, true, options3);
                console.log(`after az login with SP: stdout:\n ${output3}; stderr:\n ${error3}`);
            }
            isAzCLISuccess = true;
...
function executeAzCliCommand(command, silent, options = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield exec.exec(`"${azPath}"`, params, options);
        }
        catch (error) {
