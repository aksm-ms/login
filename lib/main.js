    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (allowNoSubscriptionsLogin) {
                ...
                yield executeAzCliCommand(`login --service-principal -u "${servicePrincipalId}" -p "${servicePrincipalKey}" --tenant "${tenantId}"`, true, options2);
                ...
                yield executeAzCliCommand(`account set --subscription "${subscriptionId}"`, true, options3);
                console.log(`after az login with SP: stdout:\n ${output3}; stderr:\n ${error3}`);
            }
            isAzCLISuccess = true;
