...
class Utils {
    ...
    static setPSModulePath(azPSVersion = "") {
        ...
        switch (runner.toLowerCase()) {
            ...
            case "windows_nt":
                ...
                let winPath = "C:\\Program Files\\WindowsPowerShell\\Modules\\";
    ...
    static getLatestModule(moduleName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let e = Date.now();
            let timeTaken = e - s;
            console.log(`time taken for init: ${Math.floor(timeTaken / 1000)}`);
            s = Date.now();
            ...
            e = Date.now();
            timeTaken = e - s;
            console.log(`time taken for running script of getmodulescript: ${Math.floor(timeTaken / 1000)}`);
            ...
            console.log(`time taken inside script for getlatestmodule: ${result.secs}`);
