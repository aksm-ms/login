...
class ServicePrincipalLogin {
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            Utils_1.default.setPSModuleBasePath();
            const azLatestModulePath = yield Utils_1.default.getLatestModulePath(Constants_1.default.moduleName);
            // Utils.setPSModulePath(`${Constants.prefix}${azLatestVersion}`);
            Utils_1.default.setPSModulePath(`${azLatestModulePath}`);
        });
    }
    login() {
        return __awaiter(this, void 0, void 0, function* () {
